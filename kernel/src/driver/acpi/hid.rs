...
static ACPI_HID_TO_HUMAN_READABLE_NAME_MAPPING: Map<&'static str, &'static str> = phf_map! {
    ...
    "PNP0344" => "Korean Enhanced keyboard 101c",
    "PNP0345" => "Korean Enhanced keyboard 103/106",
    ...
    // Hyper-V
    "VMBUS" => "Microsoft Hyper-V VMBus",
    "HYPER_V_GEN_COUNTER_V1" => "Microsoft Hyper-V Generation Counter",
};

pub struct AcpiHid(String);
...
impl AcpiHid {
    ...
    pub fn human_readable(&self) -> Option<&str> {
        ACPI_HID_TO_HUMAN_READABLE_NAME_MAPPING
            .get(&self.0)
            .copied()
    }
}

impl Debug for AcpiHid {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        f.debug_struct("AcpiHid")
            .field("raw", &self.raw())
